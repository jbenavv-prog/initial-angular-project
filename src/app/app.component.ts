...
export class AppComponent {
  ...
  title: string = 'Inicios en Angular';
  subTitle: string = 'Hola Mundo';
  car: string = 'Mazda';
  ...
  ngOnInit() {
    ...
    this.people = [
      { fName: 'Ramón', age: 35, gender: 'M' },
      { fName: 'Ximena', age: 20, gender: 'F' },
      { fName: 'Laura', age: 25, gender: 'F' },
      { fName: 'Gerardo', age: 29, gender: 'M' },
    ];

    this.http.get(`http://localhost:3000/api/4`).subscribe((result: any) => {
      console.log(result.data);
      this.airbnData = result.data;
    });
  }
  ...
  sendPrice() {
    ...
    this.http
      .post(`http://localhost:3000/api/8`, { price: this.price })
